...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    //UINavigationController *dvdvc = [[ UINavigationController alloc] initWithRootViewController:dvdvc];
    //dvdc.tabBarItem.title = @"Top DVDs";
    //dvdc.tabBarItem.image = [UIImage imageNamed:@"dvd"];
    
    tabbarController.viewControllers = @[mnvc, dvdvc];
